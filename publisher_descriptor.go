...
type PublisherDescriptor struct {
	...
	// ProducerID is a per-process identifier (UUIDv7) surfaced for replica
	// disambiguation in DLQ headers and span attributes. It is generated by
	// NewProducer and is NOT stable across restarts. Callers typically leave
	// this field zero on the base descriptor and let (*Producer).Descriptor
	// populate it from the running Producer instance.
