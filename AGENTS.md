...
- Definition-scoped routes WIN over catch-all routes: when a definition has at least one route naming it, catch-all routes do not also fire for it. That is what makes "shadow only THESE events to SQS" expressible without double-publishing the rest.
