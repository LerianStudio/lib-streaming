...
func TestSanitizeBrokerURL(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			mustContainAny: []string{"sasl://" + redactedMarker + "@broker.example.com:9092/cluster"},
		},
		{
		...
		},
		{
			...
			mustNotContain: []string{"eyJhbGciOiJIUzI1NiJ9"},
			mustContainAny: []string{"Authorization: Bearer " + redactedMarker},
		},
		{
			...
			mustContainAny: []string{"Authorization: Basic " + redactedMarker},
		},
		{
		...
		},
		{
			...
			mustContainAny: []string{"Auth: Token " + redactedMarker},
		},
		{
			...
			mustContainAny: []string{"Authorization: CustomScheme " + redactedMarker},
		},
		{
		...
		},
		{
			...
			mustContainAny: []string{"X-Amz-Credential=" + redactedMarker, "X-Amz-Signature=" + redactedMarker},
		},
		{
			...
			mustContainAny: []string{"X-Amz-Security-Token=" + redactedMarker},
		},
		{
			name:           "AWS snake session token kv",
			in:             "config aws_session_token=sessiontokenvalue region=us-east-1",
			mustNotContain: []string{"sessiontokenvalue"},
			mustContainAny: []string{"aws_session_token=" + redactedMarker},
		},
		{
