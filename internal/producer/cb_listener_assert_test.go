...
// no metric, so the per-target rt.state stops mirroring under a detached
// listener and outbox fallback never triggers on broker outage. Most
// dangerous finding in the sweep.
//
